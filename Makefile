...
#    Updated: 2019/07/11 16:12:44 by fsinged          ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRCS_FILES = ft_printf.c ft_error.c ft_flags.c ft_length_flag.c ft_octal.c \
	...
	ft_double_convert.c ft_double_exp.c ft_strspace.c
...
LIB_SRCS_FILES = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
	...
	ft_max.c ft_min.c ft_sqrt.c ft_strpcat.c ft_strrev.c ft_strddel.c
